...
#'
#' # with(train.dat,
#'     build_MOTTE_forest_MOD(x.b, x.e, treat, y.b, y.e)
#' #)
#'
#'
#' nodesize=10
...
build_MOTTE_forest_MOD <- function(
  x.b, x.e,
  treat,
  y.b, y.e,
  #method = "Exhaust",
  ...
  if(nCore==1)
  {
    ...
    forest <- foreach(i = 1:ntree,
                      .combine = c,
                      .export=c("build_MOTTE_tree_MOD","is.between", "stable.CCA"),
                      .multicombine = TRUE,
                      .verbose=TRUE,
