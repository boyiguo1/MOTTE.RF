        ...
        cbind(
          matrix(
            c(1:3/sqrt(20), rep(0, p-3),
              rep(0,3), 1:3/sqrt(20), rep(0, p-6),
              rep(0,6), 1:3/sqrt(20), rep(0, p-9)),
            nrow = p, ncol = 3),
          -1*matrix(
            c(1:3/sqrt(20), rep(0, p-3),
              rep(0,3), 1:3/sqrt(20), rep(0, p-6),
            ...
            nrow = p, ncol = 3),
          matrix(
            c(c(1,-1,1)*(1:3)/sqrt(20), rep(0, p-3),
              rep(0,3), c(-1,1,-1)*(1:3)/sqrt(20), rep(0, p-6),
              rep(0,6), c(1,1,-1)*(1:3)/sqrt(20), rep(0, p-9)),
            nrow = p, ncol = 3),
